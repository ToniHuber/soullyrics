        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <AnimatedSection>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-surface-800 border border-white/10 flex items-center justify-center group-hover:border-gold-500/30 transition-colors">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-4 py-3.5 bg-surface-800/50 border border-white/10 rounded-xl text-white placeholder:text-white/32 focus:outline-none focus:border-gold-500/50 focus:ring-2 focus:ring-gold-500/15 transition-all"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full pl-11 pr-4 py-3.5 bg-surface-800/50 border border-white/10 rounded-xl text-white placeholder:text-white/32 focus:outline-none focus:border-gold-500/50 focus:ring-2 focus:ring-gold-500/15 transition-all resize-none"
                        required
                      />
                    </div>
                  </div>
