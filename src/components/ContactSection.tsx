...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-24 sm:py-32">
      ...
      <div className="floating-orb w-[500px] h-[500px] bg-brand-600 top-1/2 -left-60" />
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white/40 text-sm">@soullyrics.studio</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white/40 text-sm">hello@soullyricsstudio.com</p>
                </div>
              </a>
            </div>
          </AnimatedSection>
            ...
            <div className="glass-card p-8">
              {sent ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-white/50 mb-6">Wir melden uns bald bei dir.</p>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-4 py-3.5 bg-surface-800/50 border border-brand-500/10 rounded-xl text-white placeholder:text-white/20 focus:outline-none focus:border-brand-500/40 focus:ring-2 focus:ring-brand-500/10 transition-all"
                        required
                      />
                    </div>
                  </div>
