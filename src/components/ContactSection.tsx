...
export function ContactSection() {
  return (
    <section id="contact" className="relative py-24 sm:py-32">
      ...
      <div className="floating-orb w-[500px] h-[500px] bg-gold-600 top-1/2 left-1/2 -translate-x-1/2" />
        ...
        <AnimatedSection>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="flex items-center gap-4 glass-card glass-card-hover px-6 py-4 text-white/62 hover:text-white transition-colors group w-full sm:w-auto"
            >
