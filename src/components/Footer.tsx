...
export function Footer() {
  return (
    <footer className="relative border-t border-brand-500/10 bg-surface-950/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-white/52 text-sm leading-relaxed max-w-xs">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-white/52 text-sm hover:text-white transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 text-white/52 hover:text-white transition-colors group"
            >
              <div className="w-10 h-10 rounded-xl bg-surface-800 border border-brand-500/10 flex items-center justify-center group-hover:border-brand-500/30 transition-colors">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/32 text-xs flex items-center gap-1">
